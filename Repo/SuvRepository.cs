...
namespace JuraganMobil.Repo
{
    internal class SuvRepository : ISuvRepository
    {
        ...
        public SuvRepository()
        {
            ...
            {
                new Suv("D 1001 UM", "SUV", 2010, 350_000_000, 3_500_000, 4, new DateOnly(2023, 01, 10),500_000,150_000),
                new Suv("D 1002 UM","SUV",2010, 350_000_000, 3_500_000, 4, new DateOnly(2023, 01, 10),500_000,150_000),
                new Suv("D 1003 UM","SUV",2015, 350_000_000, 3_500_000, 5, new DateOnly(2023, 01, 12),500_000,150_000),
                new Suv("D 1002 UM","SUV",2010, 350_000_000, 3_500_000, 5, new DateOnly(2023, 01, 13),500_000,150_000)
            };
